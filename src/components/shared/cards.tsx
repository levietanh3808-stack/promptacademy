...
export function StatCard({ label, value, note }: { label: string; value: string; note?: string }) {
  return (
    <div className="rounded-2xl border border-border/40 bg-white/90 p-6 shadow-sm backdrop-blur-md">
...
export function RoleCard({
  ...
  return (
    <div className={cn("flex flex-col rounded-3xl border p-8 backdrop-blur-md transition-all hover:shadow-xl", variant === "learner" ? "glass-card border-primary/15 hover:border-primary/30" : "glass-card border-primary-deep/15 hover:border-primary-deep/30")}>
    ...
    <div
      className={cn(
        ...
        variant === "left"
          ...
          : "glass-card border-primary-deep/15"
      )}
    >
...
export function SplitComparison({
  ...
  const connector = center ? (
    <div className="flex items-center justify-center py-2 lg:px-2 lg:py-0">
      <div className="glass-card flex w-full max-w-md flex-row items-center gap-3 rounded-2xl px-5 py-4 lg:max-w-[12rem] lg:flex-col lg:px-4 lg:py-6 lg:text-center">
